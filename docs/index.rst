...
CGAT-showcase contains a showcase example of how to build workflows suing our cgat-core  workflow management system. 
cgat-core allows you to quickly build both simple and complex reproducible pipelines completely within python. 
