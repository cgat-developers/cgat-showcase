...
htmlhelp_basename = 'cgatshowcasedoc'
...
man_pages = [
    (master_doc, 'cgatsghowcase', 'cgatshowcase Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cgatshowcase', 'cgatshowcase Documentation',
     author, 'Adam Cribbs', 'Contains a showcase example of cgat-core.',
     'Miscellaneous'),
]
